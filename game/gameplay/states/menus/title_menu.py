...
class TitleMenu(BaseUI):
    ...
    def change_state(self):
        if self.current_button == 0:#new game
            ...
            #load new game level
            #self.game.game_objects.map.load_map(self,'village_99','1')
