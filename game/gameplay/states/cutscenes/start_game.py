...
class StartGame(CutsceneEngine):#first screen to be played when starying a new game -> needs to be called after that the map has loaded
    def __init__(self,game):
        super().__init__(game)
        self.game.game_objects.camera_manager.set_camera('Start_game')#when starting a new game, should be a cutscene
