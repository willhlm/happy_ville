...
class HlifblomMapLoader(BaseLoader):
    def __init__(self, game_objects):
        ...
        self.BG = game_objects.game.display.surface_to_texture(
            pygame.image.load("assets/ui_layouts/backpack/maps/hlifblom/BG.png").convert_alpha()
        )
        path = "assets/ui_layouts/backpack/maps/hlifblom/hlifblom.json"
        #self.load_UI_data(path, "hlifblom")
        #self.load_data()
