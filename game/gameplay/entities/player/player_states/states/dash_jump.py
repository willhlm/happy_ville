...
class DashJumpPre(PhaseBase):
    ...
    def enter(self, **kwarg):
        ...
        self.entity.movement_modifier.add_modifier(
            "dash_jump", entity=self.entity, authoritative=True
        )
    ...
    def enter_state(self, state, **kwarg):
        ...
        self.entity.movement_modifier.remove_modifier("dash_jump")
    ...
    def land_from_dash_jump(self):
        should_sprint = (
            self.entity.game_objects.input_manager.is_held("gameplay", "dash")
            and self.entity.flags["sprint_chain_active"]
        )
        self.entity.flags["sprint_chain_active"] = False
        if should_sprint:
    ...
    def consume_contact_state(self):
        ...
        if self.entity.has_wall_glide_collision():
            ...
            ) or (self.entity.is_on_wall_side("left") and self.entity.dir[0] < 0)
            if (
                hit_facing_wall
                and self.entity.acceleration[0] != 0
                and self.buffer_time < 0
            ):
