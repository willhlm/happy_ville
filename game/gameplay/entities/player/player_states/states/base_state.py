...
class PhaseBase:
    ...
    def handle_press_input(
        self, input
    ):  # all states should inehrent this function, if it should be able to jump
        input.processed()

    def handle_release_input(
        self, input
    ):  # all states should inehrent this function, if it should be able to jump
        input.processed()
    ...
    def handle_movement(
        self, axes
    ):  # all states should inehrent this function: called in update function of gameplay state
        ...
        if 0.1 < abs(value[0]) < 0.65:
            ...
            multiplier = 1
        self.entity.acceleration[0] = (
            C.acceleration[0] * multiplier
        )  # always positive, add acceleration to entity
