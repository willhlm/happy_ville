...
class AmberBushBreak(LootContainers):#amber source
    def __init__(self, pos, game_objects, state, ID_key):
        ...
        self.amber_per_hit = random.randint(2, 4)
        self.health = 1
    ...
    def take_dmg(self, effect):
        ...
        if self.health > 0:
            ...
            self.hit_loot()
            self.dir[0] = -1 * effect.attacker_dir[0]
            self.currentstate.handle_input('break')
