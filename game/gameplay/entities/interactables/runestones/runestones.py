...
class Runestones(Interactables):
    def __init__(self, pos, game_objects, state, ID_key):
        ...
        self.sprites = read_files.load_sprites_dict('assets/sprites/entities/interactables/runestones/' + ID_key + '/',game_objects)
    ...
    def interact(self):
        ...
        self.game_objects.world_state.objects.set_bool(self.game_objects.map.level_name, 'runestone', self.ID_key, True)#write in the state dict that this has been picked up
