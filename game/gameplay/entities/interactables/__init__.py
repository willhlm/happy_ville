...
from .chests.amber_bush_break import AmberBushBreak
...
from .runestones.runestones import Runestones
from .save_point.save_point import SavePoint
from .shadow_light_lantern import ShadowLightLantern
...
from .traps.spirit_spikes import SpiritSpikes
