...
from gameplay.entities.base.entities_core import Animatedentity

#for map UI
class Banner(Animatedentity):
    def __init__(self, pos, game_objects, type, map_text):
        super().__init__(pos,game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/map/banner/banner_' + type + '/', game_objects)
...
class MapArrow(Animatedentity):#for invenotry, the pointer
    def __init__(self, pos, game_objects, map_text, direction):
        super().__init__(pos, game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/map/arrow/',game_objects)
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(pos[0], pos[1], self.image.width, self.image.height)
        self.time = 0
        self.map_text = map_text
...
class Rooms(Animatedentity):#the rroms in map
    def __init__(self, pos, game_objects, number):
        super().__init__(pos, game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/map/rooms/nordveden/',game_objects)
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(pos[0], pos[1], self.image.width, self.image.height)        
...
class InventoryPointer(Animatedentity):#for invenotry, the pointer
    def __init__(self,pos,game_objects):
        super().__init__(pos,game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/inventory/pointer/',game_objects)
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(pos[0],pos[1],self.image.width,self.image.height)
...
class InventoryContainer(Animatedentity):#for invenotry, will contain items
    def __init__(self, pos, game_objects, item):
        super().__init__(pos, game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/inventory/container/',game_objects)
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(pos[0],pos[1],self.image.width,self.image.height)
        self.item = item
...
class Sword(Animatedentity):
    def __init__(self,pos,game_objects):
        super().__init__(pos,game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/inventory/sword/',game_objects)#for inventory
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(pos[0],pos[1],self.image.width,self.image.height)
        self.rect.topleft = pos
...
class Hand(Animatedentity):
    def __init__(self,pos,game_objects):
        super().__init__(pos,game_objects)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/radna/hand/',game_objects)#for inventory
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(pos[0],pos[1],self.image.width,self.image.height)

#gameplay HUD
class Health(Animatedentity):#gameplay UI
    def __init__(self, game_objects, path = 'assets/sprites/ui/images/gameplay/health/'):
...
class Health_frame(Health):#gameplay UI
    def __init__(self,game_objects):
        super().__init__(game_objects, 'assets/sprites/ui/images/gameplay/health_frame/')

class Spirit(Animatedentity):#gameplay UI
    def __init__(self,game_objects, path = 'assets/sprites/ui/images/gameplay/spirit/'):
        super().__init__([0,0],game_objects)
        self.sprites=read_files.load_sprites_dict(path, game_objects)
        self.image = self.sprites['death'][0]
...
class Spirit_frame(Spirit):#gameplay UI
    def __init__(self,game_objects):
        super().__init__(game_objects, 'assets/sprites/ui/images/gameplay/spirit_frame/')

class Movement_hud():#gameplay UI
    def __init__(self,entity):
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/gameplay/ability/frame/',entity.game_objects)
        self.entity = entity
...
class Money_frame(): #HJORTRON!!!!
    def __init__(self,entity):
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/gameplay/money/',entity.game_objects)
        self.entity = entity
        self.game_objects = entity.game_objects#animation need it
        self.image = self.sprites['idle'][0]
        self.rect = pygame.Rect(0,0,self.image.width,self.image.height)
...
class Xbox(Controllers):
    def __init__(self, pos, game_objects,type):
        ...
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/controller/xbox/',game_objects)
...
class Playstation(Controllers):
    def __init__(self, pos, game_objects,type):
        super().__init__(pos, game_objects,type)
        self.sprites = read_files.load_sprites_dict('assets/sprites/ui/images/controller/playstation/',game_objects)
        self.image = self.sprites['a_idle'][0]
        self.animation.play('a_idle')
        self.rect = pygame.Rect(pos[0],pos[1],self.image.width,self.image.height)
