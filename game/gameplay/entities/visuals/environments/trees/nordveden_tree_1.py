...
class NordvedenTree_1(BaseTree):
    animations = {}
    def __init__(self, pos, game_objects, parallax, layer_name, live_blur = False):        
        ...
        #self.init_sprites('assets/sprites/entities/visuals/environments/trees/nordveden/tree_1/')#blur or lead from memory
        self.sprites = read_files.load_sprites_dict('assets/sprites/entities/visuals/environments/trees/nordveden/tree_1/', game_objects)
