...
class SeedSpawner():
    ...
    def spawn_bubble(self):#called from twoDliquid collisions with arrow
        platform = platforms.Bubble(self.arrow.hitbox.midbottom, self.arrow.game_objects, lifetime = 400)
        self.arrow.game_objects.platforms.add(platform)
...
class Seed_platform(platforms.Collision_texture):
    ...
    def pool(game_objects):
        Seed_platform.sprites = read_files.load_sprites_dict('assets/sprites/animations/seeds/platform/', game_objects)
