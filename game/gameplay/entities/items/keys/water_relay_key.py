...
class WaterRelayKey(InteractWorldItem):
    item_definition = ItemDefinition(
        item_id='water_relay_key',
        title='Water Relay Key',
        description='a key for the water relay mechanism',
        pickup_text='a key for the water relay mechanism, can perhaps be used to activate a hidden switch',
        pickup_ui_image_path='assets/sprites/ui/overlay/items/placeholder/placeholder.png',
    )
    def __init__(self,pos, game_objects, **kwarg):
        super().__init__(pos, game_objects, **kwarg)
        self.sprites = WaterRelayKey.sprites
    ...
    def pool(cls, game_objects):
        cls.sprites = read_files.load_sprites_dict('assets/sprites/entities/items/keys/water_relay_key/',game_objects)
