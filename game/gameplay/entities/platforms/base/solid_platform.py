...
from gameplay.entities.platforms.components.surface_collision import SolidSurfaceCollisionComponent
...
class SolidPlatform(Platform):
    def __init__(self, pos, size=(16, 16), run_particle='dust'):
        ...
        self.surface_collision = SolidSurfaceCollisionComponent(self)
