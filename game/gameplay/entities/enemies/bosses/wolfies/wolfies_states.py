...
class Run_main(Base_states):
    ...
    def update(self, dt):
        ...
        if abs(dist_x) < self.entity.attack_distance[0]:
            self.entity.currentstate.start_next_task()
            return        
...
@register_state(STATE_REGISTRY)
class Attack1_pre(Base_states):
    def __init__(self,entity, **kwarg):
        super().__init__(entity)
        self.entity.animation.play('attack1_pre')
...
@register_state(STATE_REGISTRY)
class Attack1_main(Base_states):
    def __init__(self,entity, **kwarg):
        super().__init__(entity)
        self.entity.animation.play('attack1_main')
        self.entity.attack(lifetime=10)      
...
@register_state(STATE_REGISTRY)
class Attack1_post(Base_states):
    def __init__(self,entity, **kwarg):
        super().__init__(entity)
        self.entity.animation.play('attack1_post')

    def increase_phase(self):
        self.entity.currentstate.start_next_task()  

@register_state(STATE_REGISTRY)
class Attack2_pre(Base_states):
    def __init__(self,entity, **kwarg):
        super().__init__(entity)
        self.entity.animation.play('attack2_pre')
        self.entity.flags['attack_able'] = False   
...
@register_state(STATE_REGISTRY)
class Attack2_main(Base_states):
    def __init__(self,entity, **kwarg):
        super().__init__(entity)
        self.entity.animation.play('attack2_main')
        self.entity.attack(lifetime=10)           
...
@register_state(STATE_REGISTRY)
class Attack2_post(Base_states):
    def __init__(self,entity, **kwarg):
        super().__init__(entity)
        self.entity.animation.play('attack2_post')
