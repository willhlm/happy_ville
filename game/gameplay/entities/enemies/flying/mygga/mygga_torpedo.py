...
class MyggaTorpedo(FlyingEnemy):#torpedo
    def __init__(self,pos,game_objects):
        ...
        self.sprites = read_files.load_sprites_dict('assets/sprites/entities/enemies/mygga_torpedo/',game_objects)#Read_files.Sprites_enteties('Sprites/Enteties/enemies/woopie/')
        self.sounds = read_files.load_sounds_dict('assets/audio/sfx/entities/enemies/mygga/')#Read_files.Sprites_enteties('Sprites/Enteties/enemies/woopie/')
