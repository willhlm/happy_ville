from gameplay.entities.enemies.common.shared.state_machine.deciders.config_utils import (
    resolve_distance,
)
from gameplay.entities.enemies.common.shared.state_machine.deciders.decision import Decision


class CheckPlayerFarDecider:
    ...
    def choose(self, player_distance, dt):
        if (
            abs(player_distance[0]) <= self.aggro_distance[0]
            and abs(player_distance[1]) <= self.aggro_distance[1]
        ):
            return []
