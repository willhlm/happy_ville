...
from gameplay.entities.enemies.common.ground.larv.hanging_component import NullHangingComponent
...
class SurfaceLarv(Enemy):
    ...
    def apply_surface_move_velocity(self, speed = None, stick_speed = None):#called from diffeerent states
