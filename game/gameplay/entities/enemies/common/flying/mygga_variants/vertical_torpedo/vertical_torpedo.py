...
class VerticalMyggaTorpedo(FlyingEnemy):#torpedo
    def __init__(self,pos,game_objects):
        ...
        self.currentstate = StateManager(self, custom_states = TORPEDO_STATES, custom_deciders = TORPEDO_DECIDERS, type = 'flying', universal_states = ['death', 'attack_pre', 'attack_main', 'wait'])
