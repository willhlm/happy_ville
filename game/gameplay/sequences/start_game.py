...
class StartGame(Sequence):
    ...
    def __init__(self, game_objects, manager, key, **kwargs):
        ...
        self.game_objects.camera_manager.set_camera('Start_game')
        self.camera_stops = list(self.game_objects.camera_blocks)
        self.game_objects.camera_blocks.empty()
    ...
    def cleanup(self):
        for camera_stop in self.camera_stops:
            self.game_objects.camera_blocks.add(camera_stop)
