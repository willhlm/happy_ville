...
class Dialogue(Conversation):#handles dialoage and what to say for NPC
    def __init__(self,entity):
        ...
        self.dialoages = {'conversation': read_files.read_json("gameplay/narrative/text/npc/conversation/" + self.entity.name + ".json"), 'comment': read_files.read_json("gameplay/narrative/text/npc/comment/" + self.entity.name + ".json") }
