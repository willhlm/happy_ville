...
class Camera():
    ...
    def update(self):
        ...
        self.true_scroll[0] += (self.game_objects.player.true_pos[0]-1*self.true_scroll[0]-self.center[0])/1
        self.true_scroll[1] += (self.game_objects.player.true_pos[1]-1*self.true_scroll[1]-self.center[1])/1
        self.scroll = self.true_scroll.copy()
        print(self.true_scroll)
        self.scroll[0] = math.floor(self.scroll[0])+self.shake[0]
        self.scroll[1] = math.floor(self.scroll[1])+self.shake[1]
