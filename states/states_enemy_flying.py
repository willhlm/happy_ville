...
class Roaming_attack(Enemy_states):#for roaming mygga
...
class Attack_main(Enemy_states):
    def __init__(self,entity):
        ...
        self.duration = 50
        distance = (self.player_distance[1]**2 + self.player_distance[0]**2)**0.5
...
class Death(Enemy_states):
    ...
    def enter_state(self, new_state, **kwarg):#don't let it go anywhere
        pass