...
class Game_Objects():
    def __init__(self, game):
        ...
        self.UI = {'gameplay':UI.Gameplay_UI(self),'map':UI.UI_loader(self,'map'),'omamori':UI.UI_loader(self,'omamori'),'journal':UI.UI_loader(self,'journal'),'fast_travel':UI.UI_loader(self,'fast_travel')}
