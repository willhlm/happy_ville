...
uniform float bloomRadius = 1; // Increase bloom radius
uniform float bloomThreshold = 0.5; // Adjust bloom threshold
uniform float bloomIntensity = 5; // Increase bloom intensity
...
void main() {
    ...
    vec3 bloom = GetBloom(imageTexture, UV, TEXTURE_PIXEL_SIZE);
