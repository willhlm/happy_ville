...
uniform vec4 color1 = vec4(0.1,1,1,1);
uniform vec4 color2 = vec4(1,0,0,1);
...
void main() {
	vec2 uv = vec2((fragmentTexCoord.x*2.0)-1.0, (fragmentTexCoord.y*2.0)-1.0);
	...
	fragColor = vec4(color * scale_factor,color);
}
