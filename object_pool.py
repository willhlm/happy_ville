import Entities, particles, entities_parallax, shader_draw, weather
...
class Object_pool():#a class that contains the objecte one may one to spawn duirng the game: it preloads stiff that needs to be loaded from file
    def __init__(self,game_objects):
        ...
        'Slash':Entities.Slash.pool(game_objects), 'Shader_draw':shader_draw.Shader_draw.pool(game_objects),'Goop':particles.Goop.pool(game_objects)}
