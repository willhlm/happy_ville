...
class Interactable_bushes(Interactable):#should it be in enemy?
    def __init__(self,pos,game_objects):
        super().__init__(pos)
        self.game_objects = game_objects
...
class Spawnpoint(Interactable):
    ...
    def interact(self,entity):#when player press t/y
